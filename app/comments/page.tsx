  ...
  return (
    <>
      ...
      <p style={{ color: "#6b7280", fontStyle: "italic", maxWidth: 680 }}>
        A forum for investigators, healthcare professionals, and patient advocates.
      </p>

      <div className="card">
        <h3 style={{ marginTop: 0 }}>Post a discussion</h3>
        <form onSubmit={post}>
      ...
      <div className="card" style={{ padding: 0 }}>
        ...
        {list.length === 0 && <p style={{ padding: "1.5rem", color: "#6b7280", fontStyle: "italic", textAlign: "center" }}>No posts yet.</p>}
      </div>
    </>
  );
}
