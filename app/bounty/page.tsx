export default function Bounty() {
  return (
    <>
      ...
      <p style={{ color: "#6b7280", fontSize: "1.05rem", maxWidth: 720 }}>
        Summit Pharmaceuticals holds sensitive clinical trial, patient, and proprietary research data. We welcome coordinated disclosure from security researchers.
      </p>
