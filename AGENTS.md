...
An intentionally vulnerable Next.js web application built for security education and bug bounty practice. It simulates a pharmaceutical company portal with deliberately insecure endpoints covering injection, XSS, IDOR, JWT weaknesses, credential exposure, and simulated command injection. **Do not deploy with real data or real users.**
